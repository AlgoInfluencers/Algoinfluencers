...
class PredictionRequest(BaseModel):
    ...
    views: int = Field(default=100000, ge=0, description="Number of views/impressions")
    likes: int = Field(default=5000, ge=0, description="Number of likes")
    comments: int = Field(default=500, ge=0, description="Number of comments")
    shares: int = Field(default=200, ge=0, description="Number of shares/retweets")
    engagement_rate: float = Field(default=0.08, ge=0, le=1, description="Engagement rate (0 to 1)")
    sentiment_score: float = Field(default=0.0, ge=-1, le=1, description="Sentiment score from -1.0 to 1.0")
    ...
    posting_hour: int = Field(default=12, ge=0, le=23, description="Hour of the day (0-23)")
    posting_month: int = Field(default=6, ge=1, le=12, description="Month of the year (1-12)")
